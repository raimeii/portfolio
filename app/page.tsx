  ...
  return (
    <div className="min-h-screen pt-12">
      <main className="container mx-auto px-4 py-32 text-center">
        <section id="head">
          <h1 className="text-5xl font-bold pb-4 text-text">Hey! I&apos;m Allen.</h1>
          <p className="text-xl pb-8 text-text">Nice of you to stumble on into here!</p>
        </section>

        <section id="about-me" className="border-2 bg-background px-6 py-10 rounded-xl border-opacity-30 max-w-7xl mx-auto">
          ...
          <div className="pt-4 flex flex-col sm:flex-row gap-10">
            ...
            <div className="flex-1">
              ...
              <p className="text-text text-left space-y-1">
                ...
                <span><strong>Fitness:</strong>&nbsp;Novice powerlifter, although currently recovering from a bouldering injury. </span><br />
              </p>
            </div>
